...
import { fileContentRequest, guess, startGame } from '../../state/game.actions';
...
class MenuOptionGame extends MenuOption {
  tabIcon = 'play_arrow';
  name ='play';
}
...
@Component({
  ...
  templateUrl: './menu-option-game.component.html',
  styleUrl: './menu-option-game.component.scss',
  providers: [{ provide: MenuOption, useValue: forwardRef(() => new MenuOptionGame()) }]
})
export class MenuOptionGameComponent implements OnInit {
  ...
  @Input()
  selected: FileItemNode | null = null;
  ...
  guess() {
    ...
    this.store.dispatch(guess({ guess: this.selected.obj }));
  }
}
